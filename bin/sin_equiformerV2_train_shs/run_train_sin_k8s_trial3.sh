...
experiment_name=run_train_sin_k8s_trial3
yaml_path=${PROJECT_DIR}/yamls/refine_train_yamls/run_train_sin_local_trial4.yaml
...
max_lr=0.0001
output_dir=/nfs_beijing_ai/jinxian/rama-scoring1.3.0/run_train_sin_k8s_trial3/
# mkdir -p ${output_dir}
#launch_mode=$1
