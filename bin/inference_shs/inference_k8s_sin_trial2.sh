...
# 输出的pdb综合数据csv存储路径
# refine pdb的保存路径
refine_pdb_path='/nfs_beijing_ai/jinxian/rama-scoring1.3.0/dataset/datasets/inference/pdb_file_trial3/'

input_path='/nfs_beijing_ai/jinxian/rama-scoring1.3.0/dataset/datasets/model_zoo_nb_no4_95_testset_0522.csv'
ckpt_path='/nfs_beijing_ai/jinxian/rama-scoring1.3.0/model/ckpt/run_train_sin_k8s_trial3_2024.11.18-12.13.00_Step_100000_improve_rat_0.0831341980535005_imporve_num_168.ckpt'
output_path='/nfs_beijing_ai/jinxian/rama-scoring1.3.0/dataset/datasets/inference/'
yaml_path=${PROJECT_DIR}/yamls/refine_train_yamls/run_train_sin_k8s_trial3.yaml
