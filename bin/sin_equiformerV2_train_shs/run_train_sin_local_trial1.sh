...
experiment_name=run_train_sin_local_trial2
yaml_path=${PROJECT_DIR}/yamls/refine_train_yamls/run_train_sin_local_trial2.yaml
...
max_lr=0.0001
output_dir=/nfs_beijing_ai/jinxian/rama-scoring1.3.0/trial1/
# mkdir -p ${output_dir}
#launch_mode=$1
