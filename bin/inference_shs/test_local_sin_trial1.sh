...
# 输出的pdb综合数据csv存储路径
# refine pdb的保存路径
refine_pdb_path='/nfs_beijing_ai/jinxian/rama-scoring1.3.0/dataset/datasets/test/'

input_path='/nfs_beijing_ai/jinxian/rama-scoring1.3.0/dataset/datasets/model_zoo_nb_no4_95_testset_0522.csv'
ckpt_path='/nfs_beijing_ai/jinxian/rama-scoring1.3.0/model/ckpt/2024.10.31-10.19.03_Step_136637_improve_rat_0.0506243271965237_imporve_num_343.ckpt'
output_path='/nfs_beijing_ai/jinxian/rama-scoring1.3.0/dataset/datasets/test/'
yaml_path=${PROJECT_DIR}/yamls/refine_train_yamls/run_train_sin_k8s_trial1.yaml

# mkdir -p $output_path

CUDA_VISIBLE_DEVICES=${device_id} python ${PROJECT_DIR}/run_test_sin.py \
